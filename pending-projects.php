<?php
    ...
    if($userType==='User'){
        ...
        WHERE 
             ...
             AND prdata.`Status`='Amount Pending'
    ...
    elseif($adminType==='Admin')
    {
        ...
        JOIN client cl ON prdata.ClientId = cl.ClientId
        ORDER BY `prdata`.`projid` ASC
        WHERE  prdata.`Status`='Amount Pending'
        ORDER BY prdata.projid ASC";
    }
            ...
            <div class="card1">
                <?php if ($total != 0) {?>
                    <table border="4">
                        <thead > 
                            <tr>
                                <td colspan="100%"  class="thtr">Amount Pending Project Data</td>
                            </tr>
                            <tr class="thead">
                            ...
                            while (($res = mysqli_fetch_assoc($data))) {
                                ...
                                <tr class="tr" >
                                    ...
                                    <td class="tdstyle">';
                                        ...
                                        echo '</td>
                                    <td class="tdstyle">' . ($res["PerCandRate"] !== null ? $res["PerCandRate"] : '') . '</td>
